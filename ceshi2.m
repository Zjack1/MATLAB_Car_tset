...
[m1 n1]=size(C1);
Sx1=sum(C1);     % 求垂直投影
figure,plot(1:n1,Sx1);
for e=1:n1-1
    if((Sx1(e)==0&Sx1(e+1)>0)|(Sx1(e)>0&Sx1(e+1)==0))
        v(e)=e;
    end
end
V=find(v>0);
...
%     end
% end
% figure,subplot(211),plot(1:n1,x1);

Sy1=sum(C1,2);    % 求水平投影
figure,plot(1:m1,Sy1);   
% for i=1:m1         
%     if Sy1(i)>1   %设置阈值
%         y1(i)=Sy1(i);
%     else
